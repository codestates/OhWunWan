...
// ohwunwan
router.get('/ohwunwan', post_controller.ohwunwan.get);//게시글 조화
...
//feedback
router.get('/feedback', post_controller.feedback.get);//게시글 조화
...
//bench_1rm
router.get('/bench_1rm', post_controller.bench_1rm.get);//게시글 조화
...
//dead_1rm
router.get('/dead_1rm', post_controller.dead_1rm.get);//게시글 조화
...
//squat_1rm
router.get('/squat_1rm', post_controller.squat_1rm.get);//게시글 조화
