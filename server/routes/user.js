...
router.get('/1rm/:user_id/:count', user_controller.bench_1rm);//user bench_1rm게시물 정보요청
router.get('/1rm/:user_id/:count', user_controller.dead_1rm);//user dead_1rm게시물 정보요청
router.get('/1rm/:user_id/:count', user_controller.squat_1rm);//user squat_1rm게시물 정보요청
